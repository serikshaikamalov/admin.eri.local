...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="list-group">
            <a href="/event" class="list-group-item list-group-item-action">Event List</a>
            <a href="/event-category" class="list-group-item list-group-item-action active">Event Category</a>
        </div>
    </div>
